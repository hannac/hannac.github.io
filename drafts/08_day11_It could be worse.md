...
로그로뇨에서 나헤라까지는 28km 정도의 거리이다.
그러나 중간에 벤토사라는 마을로 돌아가서 총 31km 정도를 걷게 된 날이다.
...
로그로뇨에서 출발하여 19km 정도 걸었을 때 벤토사로 돌아가는 길이 나뉘는 지점에 다다랐다. 
3km를 돌아서 더 걸을지 고민하다가 벤토사 마을이 아름답다는 이야기를 들었기에 돌아가 보자고 결정했다.

![](../images/day11/20191020_130732.jpg)

때는 이미 순례의 비수기에 접어든 시기였고 그나마도 주 길이 아니었기에 벤토사로 우회하는 길에는 아무도 없었다.
그렇게 우회로에 접어들었는데 저 멀리 아주 짙고 낮게 깔린 구름이 보였다. 

![](../images/day11/20191020_121422.jpg)

제발 저 구름이 비를 쏟아내는 먹구름이 아니기를 바랐다. 
또 내가 가는 길이 저 아래를 통과하는 것이 아니기를 바라며 
우회로를 걷기 시작했다. 
하지만 얼마 되지 않아 빗방울이 떨어지기 시작했다.

처음 내리던 빗망울은 판초를 꺼내 입을 정도는 아니었다. 
배낭에만 레인 커버를 씌우고 조금씩 맞으며 걸었다.
...
처음으로 배낭에서 판초 우비를 꺼냈다.
땅은 이미 쏟아지는 비로 모두 젖어 배낭을 땅에 내리고 판초를 꺼낼 수 없었다.
판초를 꺼내려고 보니 그간 사용한 적이 없어서 꺼내기 쉬운 곳에 들어 있지도 않았다.

판초를 처음으로 입는 것이었다. 이미 쏟아지는 빗속에서 꺼내 입으려 하니 
배낭의 레인커버를 벗기고 배낭을 열어 판초를 꺼내는 것도 펼치는 것도 쉽지 않았다. 
배낭을 다시 잠근 후 레인커버를 씌우고 배낭까지 덮이도록 판초를 몸에 뒤집어 쓰는 것도 모든 것이 서툴렀다.
조그맣게 돌돌 말려 접혀진 판초와 씨름하며 뒤집어 쓰는 것만도 내겐 전쟁이었다.

어찌어찌 판초를 둘러 썼다. 제대로 여미지도 못하여 판초가 비바람에 펄럭거렸다. 
그렇지만 어떻게 더 할 수가 없어서 그대로 다시 걷기 시작했다.
쏟아지는 빗물이 제대로 여며지지 않은 판초를 타고 옷 안으로 흘러 들었다.
이럴 거면 도대체 판초를 왜 입은 거지 싶었다. 아까 빗방울이 조금 떨어질 때 미리 입을 걸 하는 후회가 밀려왔다.
여전히 길은 우회로라 아무도 없었고 되돌아가기엔 이미 너무 들어왔다. 그냥 계속 가는 수 밖에 없었다.
중간중간 나타나는 산티아고 길의 표지석만이 내가 길을 벗어나지는 않았음을 알리고 있었다.

산티아고 길에서 처음 맞아 보는 폭우였다.
폭우에 가려 5m 앞도 보이지 않았기에 아름답다는 마을은 아무것도 보이지 않았다. 
길가에 있다는 1km 의 예술 작품들을 감상할 수도 없었다.
그저 길 옆의 추수가 끝나 땅을 드러낸 황량한 밀밭만이 남아 있었다.
어차피 이렇게 아무것도 볼 수 없을 바엔 그냥 원래 길로 갈 것을 싶었다.
괜히 거리만 늘어났다는 후회도 밀려들었다.

1km쯤 더 걸었을 때에야 벤토사 마을의 초입이 나타났다. 
그곳에 버스 정류장이 보였다. 지붕이 있고 벤치가 있어 비를 피해 잠시 숨을 고를 수 있어 보였다.
...
비는 조금 잦아들었어도 여전히 많이 오고 있었기에 판초를 벗을 수는 없었다.
...
산비탈을 따라 폭포가 되어 흐르는 흙탕물을 밟고 싶지 않았다.
그러나 좁은 산길에서는 도저히 피할 수 없는 곳이 더 많았다.
흙탕물을 피할 길은 없고 판초는 엉망으로 입어서 
빗물이 들어오니 배낭은 더 무겁게 느껴졌다.

내가 왜 여기 와서 이러고 있지 라는 생각으로 가득했다. 
그렇지만 당장은 흙탕물을 피해야 해서 땅만 보며 산을 오르고 올랐다. 
그러다 앞에 아주 커다란 나무가 한 그루 서 있는 것이 보였다.
...
각자 판초의 빗물도 털며 다시 매무새를 다듬었다.
그제야 내가 판초를 거꾸로 뒤집어 입었음을 알았다. 
그러나 이미 안쪽이 밖으로 나와 젖어 버렸으니 목적지에 도착할 때까지는 
그대로 입는 수밖에 없었다.
...
아… 그 대답은 어쩌면 단순히 '비가 예상보다 많이 온다'던 내 말에 답을 해 주었던 것일 수도 있다. 
하지만 설령 정말로 단순한 대답이었다고 해도 그 한 마디는 인생의 연륜에서 비롯된 말로 들렸다.

그 할아버지에게도 이 폭우가 쉽지 않았을 터인데 
인생의 노년에 있는 분이 마치 이 정도는 아무것도 아니라는 듯 
아주 밝은 미소를 지으며 말해준 'It could be worse. (더 나쁠 수도 있었어)' 는 
다른 울림으로 다가왔다.

그 비가 쏟아지는 산 속의 나무 아래서 그 할아버지의 한 마디는 
내게 비단 이 폭우 뿐 아니라 인생의 모든 것에 대해 
'더 나쁠 수도 있었어, 이 정도 별 거 아냐, 하하하.' 라는 말로 들렸다.
...
정말 그랬다. 그날의 날씨만 생각해도 더 나쁠 수도 있었다. 
그리고 그런 빗속에서 좌충우돌 고군분투 했어도 
어떻게든 판초를 꺼내 입고 그 길을 걸을 수 있을 만큼의 건강과 체력이 
있다는 것만 해도 사실은 정말 괜찮은 거였다.
...
사진을 찍어도 된다고 말하는 내 표정은 이미 완전히 활짝 웃는 웃음으로 바뀌어 있었다.
