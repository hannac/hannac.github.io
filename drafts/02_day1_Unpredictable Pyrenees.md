...
내 뒤에서 나타난 그들은 'Bonjure~'(봉쥬~) 인사를 건네곤 앞으로 빠르게 사라져갔다. 
그들의 다리가 더 튼튼했다.
...
오리손까지만 해도 가파른 오르막이 많았던데다 
이 정도 두 시간 반 연속 산행조차 한국에서 해 본지 너무 오래전이었다. 
...
그래서 물병 3개를 준비했고 이는 곧 무게 1.5kg이 추가됨을 의미한다.

작은 배낭만을 지고 있었기에 배낭이 무거운 것은 아니었지만 첫날이라는 무게가 무거웠다.
...
점점 깊숙한 피레네로 들어가는 동안 
고도 역시 점차 높아져가고 바람은 계속 불어치니 조금씩 추워지기 시작했다.
하지만 산행으로 몸에서 열기도 계속 오르고 있었기에 
바람이 식혀주는 것으로 여기면 추위에 대비해 
보내는 짐에 넣지 않고 들고온 경량 패딩은 안입고 버틸 수 있을 것 같았다.

그렇게 바람을 견디고 견뎠는데 몸이 너무나 식어버렸는지 덜덜 떨리기 시작했다. 
어느 순간부터는 추위를 견딜 수 없을 지경이었다. 
어쩔 수 없이 가방에서 패딩을 꺼내 입었다. 
그런데 추워서 입은 패딩이 무색하게 곧 바람이 잦아들었다.  

그러나 조금 겪어본 바 피레네에서 바람이 불지 않을리가 없잖은가.
'앞으로도 남은 길은 길고 산은 깊으니 곧 바람이 또 불겠지..?' 라는 생각으로 
패딩을 벗지 않고 계속 걸었다.
그런데 이번에는 바람이 불지 않는 구간이 길어졌다. 

점점 더워지더니 더위를 도무지 견딜 수 없었다.
분명 바람이 불 때는 몸이 덜덜 떨릴 정도로 추웠는데 
이제는 찜통같이 더워서 온 몸과 옷이 땀에 절여지고 있었다.
덧입은 패딩마저 땀에 젖어 축축해지는 것이 느껴질 정도졌다.
바람이 한 점도 없어 너무나 더운데 땀에 절은 옷이 무겁게 느껴지기 시작하니 견디기가 더더욱 힘들었다.
도저히 안되겠다는 생각이 들어 또 다시 가방을 내려 패딩을 벗고 말아서 넣었다. 

더위를 못견디겠어서 패딩을 벗어 말아 넣은지 불과 얼마 되지 않았는데 
이번에는 약올리듯 몸이 밀리는 세찬 바람이 또다시 몰아치기 시작했다.
벗지 말고 조금만 더 버틸걸 싶었다.
바람이 내가 옷을 입고 벗는 것을 지켜보는지 
마치 바람에 농락당하는 것 같았다.

땀에 절여진 몸에 강풍이 몰아치자 빠르게 몸이 식어갔다.
정상에 다가갈수록 거세지는 바람에 또 다시 덜덜 떨 정도가 되어서야 
가방에 말아 넣었던 경량 패딩을 꺼내 입었다.

새벽에 길을 나섰을 때 추울 것 같아 패딩을 입었지만 
오리손까지 가는 동안의 오르막에서 너무 더워 찜통 같기에 벗어들며
보내는 짐에 넣을 것을 짐만 늘게 괜히 들고 왔다 싶었다. 
그런데 이번엔 입고 와서 다행이라는 생각이 들었다.

그렇게 번갈아 찾아오는 바람과 추위에는 안입고 견디며 덜덜 떨거나
반대로 더위에는 안벗고 땀을 뻘뻘 흘릴 정도가 되어서야 
약올림 당하는 느낌으로 뒤늦게 패딩을 입고 벗는 것을 반복하고 있었다.
...
패딩을 입고 벗을때마다 가방을 내렸다 메었다를 반복해야 하는
...
버티다가 또 다시 땀에 절여져 도저히 못견뎌 벗으면 그제야 바람이 불었다.
도무지 중간이 없었다. 어찌 이럴수가! 
이렇게 내 나름의 생각들은 몇 시간이 채 안되는 사이 셀 수 없이 깨어지고 있었다.  
인생에서 예측 가능한 것은 예측 할 수 없다는 것 뿐이라고 했던가.
피레네의 바람을 예측해보려는 시도가 의미가 없다는 생각이 들자 
그냥 지금 바로 대처할 수 있는 것을 하는 편이 낫구나 싶었다.

그제서야 깊은 산속에서
이 높이까지 올라와서 풀을 뜯는 여기저기의 양 무리들과
봉우리들만이 첩첩이 쌓인 피레네의 풍경이
저 멀리서부터 한 눈에 담겨왔다.
정말 맑은 하늘은 청명 그 자체였다.
...
어차피 이 피레네를 넘는 것은 열시간이 넘게 걸리는 길이고 
...
이제는 론세스바예스에 도착한 내게 여전히 무뚝뚝하지만 조금은 친근한 시선을 고요히 보내고 있었다.
