...
프랑스 길 첫날에 대한 이야기는 워낙 유명한데 
산티아고 길을 걸으려고 알아보는 사람들은 
생 쟝(Saint-Jean-Pied-de-Port:생 쟝 삐에 데 뽀흐)에서 
론세스바예스(Roncesvalles)로 향하는 피레네 산맥을 넘는 이야기부터 접하게 되곤 한다.

나폴레옹이 넘었다는 나폴레옹 루트에 대한 이야기다. 열 시간을 넘게 걸었다는 이야기부터 산 위의 바람이 엄청나게 세차서 몸이 
밀린다거나 정상 부근의 날씨는 예측할 수 없을 뿐 아니라 
...
낮은 지대인 해발 165m 인 생 쟝에서 출발하여 고도가 1430m 가 넘는 피레네를 
...
나도 생 쟝에 도착하여 순례자 등록을 마친 뒤 피레네를 대비했다.   
...
준비하는데만 한 시간이 넘게 걸렸고 당연히 아침을 먹을 시간은 없었다. 
500ml 물통 세 병에 물을 채웠다. 
전날 사둔 빵, 과일을 작은 가방에 챙기고 생 쟝으로 오던 기차에서 알게 된 
동현씨와 알베르게에서 알게된 미국인 새라도 함께 출발했다.

생 쟝을 빠져나가면서부터는 계속해서 올라가는 길이었다. 
...
저 아래로 아직 아침 안개에 쌓인 고요한 생 쟝이 보였다. 
...
생 쟝이 해발 165m 이기 때문에 꽤 높은 산을 오른 셈이랄 수 있는데
...
탈수로 위험하기 때문에 최소 물 1L는 준비해야 한다는 말도 부담되었다.
...
한편으로는 계속 부는 바람이 산에 오르느라 몸에서 나던 열기를 식혀주니 
시원하다고도 느꼈다.

점점 깊숙한 피레네로 들어가는 동안 
고도 역시 점차 높아져갔다. 바람도 계속 불어치니 조금씩 추워지기 시작했다.
하지만 산행으로 몸에서 열기도 계속 오르고 있었기에 
바람이 식혀주는 것으로 여기면 추위에 대비해 
보내지 않은, 작은 배낭에 말아 넣어온 경량 패딩은 안입고도 버틸 수 있을 것 같았다.

그렇게 바람을 견디고 견뎠는데 몸이 너무나 식어버렸는지 덜덜 떨리기 시작했다. 
어느 순간부터는 추위를 견딜 수 없을 지경이었다. 체온이 너무나 떨어지기 시작하는게 느껴졌다.
어쩔 수 없이 배낭에서 패딩을 꺼내 입었다. 
...
패딩을 벗지 않고 계속 걸었다.
그런데 이번에는 한참이나 바람이 불지 않는 것이다. 

바람이 불지 않으니 점점 더워지면서 더위를 도무지 견딜 수 없었다.
...
도저히 안되겠다는 생각이 들어 배낭을 내리고 패딩을 벗어 말아 넣었다. 

더위를 못견디겠어서 패딩을 말아 넣은지 불과 얼마 되지 않았는데 
이번에는 약올리듯 몸이 밀리는 세찬 바람이 또다시 몰아치기 시작했다.
이럴 줄 알았으면 벗지 말고 조금만 더 버틸걸 싶었다.
바람이 내가 옷을 입고 벗는 것을 지켜보는지 
마치 바람에 농락당하는 것 같았다.

땀에 절여진 몸에 강풍이 몰아치자 빠르게 몸이 식어갔다.
하지만 배낭에 패딩을 넣은 지 얼마 되지도 않았고 
또 바람이 금방 그칠지도 모른다는 생각에 바람을 그냥 버텼다.
정상에 다가갈수록 거세지는 바람에 도무지 버텨낼 재간이 없었다.
또 다시 덜덜 떨 정도가 되어서야 가방에 말아 넣었던 경량 패딩을 꺼내 입었다.

새벽에 길을 나설 때 추울 것 같아 패딩을 입었다. 
오리손까지 가는 오르막에서 너무 더워 찜통 같기에 벗어들곤 
작은 배낭에 말아 넣으며
론세스바예스까지 보낼 것을 짐만 늘게 괜히 들고 왔다 싶었다. 
그런데 이번엔 입고 와서 다행이라는 생각이 들었다.

그런데 산 위에서 이렇게 번갈아 찾아오는 바람과 추위에는 
안입고 견디며 덜덜 떨거나
...
패딩을 입고 벗을때마다 작다곤 하지만 배낭을 내렸다 메었다, 
말아 넣었다 빼냈다하는 반복이라도 조금 덜 하고 싶은 심정이었던 것이다.
조금이라도 덜 괴롭고 싶어서 한 선택이었는데 결국은 의미가 없었다.

> '지금 춥지만 입었다가 바람이 곧 그치면 또 벗어야 할테니 그냥 입지 말고 버텨보자.'

라고 버티면 바람이 그치질 않아 한참이나 추위에 떨다가 견딜수가 없는 지경이 되어서야 겨우 입었다.  
...
더워도 버티다가 또 다시 땀에 절여져 도저히 못견뎌 벗으면 그제야 바람이 불었다.
그러면 또 다시 땀이 바람에 식어 온 몸이 덜덜 떨려왔다.
조금만 더 버텼으면 됐을 텐데 그 바람이 언제 불어 추워질 지, 언제까지 더울 지 
아무것도 알 수가 없었다.
...
그제서야 깊은 산속에서
이 높이까지 올라와서 풀을 뜯는 여기 저기의 양 무리들과
...
삶은 한 걸음 앞도 예측 불가능하다는 것을 무심히 알려주더니
이제는 론세스바예스에 도착한 내게 어쩐지 조금은 친근한 시선을 고요히 보내고 있었다.


생 쟝에 도착한 날 동키 사무실에 배낭을 맡기러 들어갔을 때, 봉사자와의 대화가 생각났다.
